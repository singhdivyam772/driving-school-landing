...
import { Car, Eye, EyeOff, ArrowLeft, Mail, Lock, LogIn } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-12">
          <Card className="w-full max-w-md hover:scale-105 transition-all duration-300 hover:shadow-2xl bg-white/95 backdrop-blur-sm animate-fade-in-up">
            <CardHeader className="text-center space-y-4">
              ...
              <CardDescription className="text-gray-600">
                Sign in to your DriveAce Academy account to continue your driving journey
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                  size="lg"
                >
                  Sign In
                </Button>
